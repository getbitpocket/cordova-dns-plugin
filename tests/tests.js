cordova.define("cordova-plugin-dns-test.tests", function(require, exports, module) { exports.defineAutoTests = function() {
    describe('Dns Query Tests', function () {
        ...
        it("an invalid domain error should be returned", function(done) {
            cordova.plugins.dns.resolve('zzzz///',function () {}, function (error) {
